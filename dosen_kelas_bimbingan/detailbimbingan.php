              ...
              <div class="col-lg-12">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    ...
                    $de_idbimbingan = decriptData($idbimbingan);
                    $qweri = mysqli_query($conn, "SELECT nidn,kode_periode,nim FROM tbl_kelas_bimbingan WHERE id_kelas='$de_idbimbingan'") or die(mysqli_error($conn));
                              ...
                              <div class="col-lg-8">
                                ...
                                <div class="card card-primary card-outline direct-chat direct-chat-primary shadow-none">
                                    ...
                                    <div class="direct-chat-messages">
                                      ...
                                      if($rvchat>0) {
                                        while($data_chat=mysqli_fetch_array($query_chat)){
                                          ...
                                          if($data_chat['nidn']==null) {
                                            //chat dari dosen (dari kiri)
                                            ?>
                                            <!-- Chat dari kiri -->
                                            <div class="direct-chat-msg">
                                              <div class="direct-chat-infos clearfix">
                                                <span class="direct-chat-name float-left"><?=$nama_mhs;?></span>
                                            ...
                                            <div class="direct-chat-msg right">
                                              <div class="direct-chat-infos clearfix">
                                                <span class="direct-chat-name float-right"><?=$nama_dosen;?></span>
                                  ...
                                  <div class="card-footer">
                                    ...
                                    $pro = @$_GET['progres'];
                                    ?>
                                    <form action="chat_dosen.php?id_kelas=<?=encriptData($idb)?>&progres=<?=encriptData($pro)?>&nidn=<?=encriptData($nidn)?>" method="post">
                                      ...
                                      <form action="" method="post">
                                        <div class="input-group">
                                          <button type="submit" name="btnjudul" class="btn btn-sm btn-success btn-block"><i class="nav-icon fas fa-check"></i> SETUJUI JUDUL</button>
                                        </div>
                                      </form>
                                      <?php
                                      if (isset($conn, $_POST['btnjudul'])) {
                                        $pro_judul = "2";
                                        $update_pro_judul = mysqli_query($conn, "UPDATE tbl_kelas_bimbingan SET progres = '$pro_judul' WHERE nidn = '$nidn' AND nim = '$nim'") or die(mysqli_error($conn));
                                        echo '<script>alert("Judul telah disetujui")</script>';
                                        echo '<script>window.location="detailbimbingan.php?id_kelas='.$idb.'&progres=2"</script>';
                                      }
                                      }
                                      if ($pro==2) {
                                        // code...
                                      ...
                                      ?>
                                      <div class="input-group">
                                        <button class="btn btn-sm btn-success btn-block"><i class="nav-icon fas fa-check"></i> SETUJUI BAB 1</button>
                                      </div>
                                      <?php
                                      }
                                      if ($pro==3) {
                                      ...
                                      ?>
                                      <div class="input-group">
                                        <button class="btn btn-sm btn-success btn-block"><i class="nav-icon fas fa-check"></i> SETUJUI BAB 2</button>
                                      </div>
                                      <?php
                                      }
                                      if ($pro==4) {
                                      ...
                                      ?>
                                      <div class="input-group">
                                        <button class="btn btn-sm btn-success btn-block"><i class="nav-icon fas fa-check"></i> SETUJUI BAB 3</button>
                                      </div>
                                      <?php
                                      }
                                      if ($pro==5) {
                                      ...
                                      ?>
                                      <div class="input-group">
                                        <button class="btn btn-sm btn-success btn-block"><i class="nav-icon fas fa-check"></i> SETUJUI BAB 4</button>
                                      </div>
                                      <?php
                                      }
                                      if ($pro==6) {
                                      ...
                                      ?>
                                      <div class="input-group">
                                        <button class="btn btn-sm btn-success btn-block"><i class="nav-icon fas fa-check"></i> SETUJUI BAB 5</button>
                                      </div>
                                      <?php
                                      }
                                      if ($pro==7) {
                                      ...
                                      ?>
                                      <div class="input-group">
                                        <button class="btn btn-sm btn-success btn-block"><i class="nav-icon fas fa-check"></i> SELESAI</button>
                                      </div>
                                      <?php
                                      }
                                      ?>
                                    ...
                                    <table class="table table-bordered table-sm">
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          if ($pro>=1) {
                                          ?>
                                          <a href="detailbimbingan.php?id_kelas=<?=encriptData($idb)?>&progres=2" class="btn btn-sm btn-primary"></a>
                                          <?php
                                          }
                                          ?>
                                        </td>
