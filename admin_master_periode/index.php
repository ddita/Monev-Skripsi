      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Master Data Periode Akademik</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Admin Dashboard</a></li>
                  <li class="breadcrumb-item active">Master Data Periode Akademik</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <a href="tambahprd.php" class="btn btn-primary btn-sm"><i class="nav-icon fas fa-download"></i> Tambah Data Periode</a>
                    ...
                    <table id="example1" class="table table-bordered table-striped table-sm">
                      ...
                      <tbody>
                        <?php
                        $no=1;
                        $queryprd = mysqli_query($conn, "SELECT * FROM tbl_periode") or die(mysqli_error($conn));
                        if (mysqli_num_rows($queryprd)>0){
                          while ($dt_periode = mysqli_fetch_array($queryprd)){
                        ?>
                        <tr>
                          <td><?=$no++;?></td>
                          ...
                          <td>
                            <center>
                              <a href="proseshapus.php?kd_prd=<?=encriptData($dt_periode['kode_periode'])?>&hapus=hapus" class="btn btn-sm btn-danger" onclick="return confirm('Anda akan menghapus data periode akademik dengan Kode [<?=$dt_periode['kode_periode'];?>] - Periode : [<?=$dt_periode['periode'];?>]')">
