        ...
        <div class="container-fluid">
          <div class="card card-outline card-primary shadow-sm">
            <div class="card-header">
              <h3 class="card-title">
                <i class="fas fa-list"></i> Data Tahun Angkatan
              </h3>
            ...
            <div class="card-body table-responsive">
              ...
              <table id="example1"
                ...
                <tbody>
                  ...
                  <?php
                  $no = 1;
                  $qangkatan = mysqli_query($conn, "SELECT * FROM tbl_angkatan");

                  if (mysqli_num_rows($qangkatan) > 0):
                    while ($dt = mysqli_fetch_assoc($qangkatan)):
                  ?>

                      <tr>
                        <td class="text-center"><?= $no++; ?></td>
                        <td class="text-center">
                          <strong><?= htmlspecialchars($dt['kode_angkatan']); ?></strong>
                        </td>
                        <td>
                          <strong><?= htmlspecialchars($dt['keterangan']); ?></strong>
                        </td>
                        <td class="text-center">
                          <a href="proses.php?action=hapus&kode_angkatan=<?= encriptData($dt['kode_angkatan']); ?>"
                            class="btn btn-sm btn-outline-danger"
                            data-toggle="tooltip"
                            title="Hapus data"
                            onclick="return confirm('Hapus periode <?= $dt['keterangan']; ?> ?')">
