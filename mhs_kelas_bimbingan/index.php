                  ...
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped table-sm">
                      ...
                      <tbody>
                        ...
                        $querybimbingan = mysqli_query($conn, "SELECT * FROM tbl_kelas_bimbingan WHERE nim = '$nim'") or die(mysqli_error($conn));
                          ...
                          while ($dt_bimbingan = mysqli_fetch_array($querybimbingan)) {
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <br><?=$dosen;?>
                                <br><a href="https://api.whatsapp.com/send?phone=<?=$arr['kontak'];?>&text=Assalamu'alaikum Bapak/Ibu <?=$arr['nama']?>" class="btn btn-sm btn-success" target="_blank">
                                  <img src="../images/logo-wa.png" height="18px" width="18px"> <?=$arr['kontak'];?>
                                </a>
                              </td>
                              <td>
                                <?php
                                $nim = $dt_bimbingan['nim'];
                                $ambilnamamhs = mysqli_query($conn, "SELECT nama FROM tbl_mahasiswa WHERE nim = '$nim'");
                              ...
                              <td>
                                <center>
                                  <a href="detailbimbingan.php?id_kelas=<?=encriptData($dt_bimbingan['id_kelas'])?>&progres=<?=encriptData($dt_bimbingan['progres'])?>" class="btn btn-sm btn-info"> <i class="nav-icon fas fa-edit"></i> Detail</a>
                                </center>
                              </td>
                            </tr>
                            <?php
