              ...
              <div class="col-lg-6">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title"><i class="nav-icon fas fa-plus"></i> Tambah Data Mahasiswa</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="proses.php" method="post">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select class="custom-select from control-border" id="prodi" name="prodi" required>
                          <option value=" ">-- Pilih Prodi --</option>
                          <?php
                          $queryprodi = mysqli_query($conn, "SELECT * FROM tbl_prodi") or die(mysqli_error($conn));
                          while($dataagama = mysqli_fetch_array($queryagama)){
                            ?>
                            <option value = <?=$dataagama['id'];?>><?=$dataagama['agama'];?></option>
                            <?php
                          }
                          ?>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="angkatan" name="angkatan" maxlength="15" placeholder="Input Angkatan Mahasiswa" onkeypress="return IsNumeric(event);" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kelamin" name="kelamin" maxlength="15" placeholder="Input Kelamin Mahasiswa" onkeypress="return IsNumeric(event);" required>
                      </div>
                    </div>
                    <!-- /.card-body -->

                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary btn-block" name="tambahmhs"><i class="nav-icon fas fa-plus"></i> Tambah Data Mahasiswa</button>
                    </div>
                  </form>
                </div>
                <!-- /.card -->
