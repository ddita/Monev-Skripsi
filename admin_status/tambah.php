...
<head>
  ...
  <title>Monev Skripsi | Tambah Status</title>
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="../admin_status">Status Skripsi</a></li>
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-6">
              <a href="../admin_status" class="btn btn-warning btn-sm mb-3">
                <i class="fas fa-chevron-left"></i> Kembali
              </a>
              <!-- general form elements -->
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title"><i class="nav-icon fas fa-open-book"></i> Tambah Status</h3>
                </div>
                <!-- /.card-header -->
                <!-- FORM TAMBAH status -->
