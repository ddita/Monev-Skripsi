        ...
        <div class="container-fluid">
          <div class="card card-outline card-primary shadow-sm">
            <div class="card-header">
              <h3 class="card-title">
                <i class="fas fa-list"></i> Data Status Skripsi
              </h3>
              ...
              <table id="example1"
                ...
                <tbody>
                  ...
                  if (mysqli_num_rows($qstatus) > 0):
                    while ($dt = mysqli_fetch_assoc($qstatus)):
                  ?>

                      <tr>
                        <td class="text-center"><?= $no++; ?></td>
                        <td>
                          <strong><?= htmlspecialchars($dt['status']); ?></strong>
                        </td>
                        <td class="text-center">
                          <a href="proses.php?action=hapus&id=<?= encriptData($dt['id']); ?>"
                            class="btn btn-sm btn-outline-danger"
                            data-toggle="tooltip"
                            title="Hapus data"
                            onclick="return confirm('Hapus periode <?= $dt['status']; ?> ?')">
