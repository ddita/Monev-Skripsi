              ...
              <div class="col-lg-6">
                ...
                <div class="card card-primary">
                  <div class="card-header">
                    <h3 class="card-title"><i class="nav-icon fas fa-plus"></i> Tambah Data Prodi</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="proses.php" method="post">
                    <div class="card-body">
                      <a href="../admin_master_prodi" class="btn btn-warning btn-sm"><i class="nav-icon fas fa-chevron-left"></i> Kembali</a>
                      <div class="form-group">
                        <label for="kodeprodi">Kode Program Studi</label>
                        <input type="text" class="form-control" id="kodeprodi" name="kodeprodi" maxlength="4" onkeypress="return IsNumeric(event);" required>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-primary btn-block" name="tambahprodi"><i class="nav-icon fas fa-plus"></i> Tambah Data Prodi</button>
                    </div>
                  </form>
                </div>
                <!-- /.card -->
